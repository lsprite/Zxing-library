...
final class FlashlightManager {
	...
	static {
		...
		if (iHardwareService == null) {
			Log.e(TAG, "This device does supports control of a flashlight");
		} else {
			Log.e(TAG,
	...
	private static Class<?> maybeForName(String name) {
		try {
			...
			Log.e(TAG, "Unexpected error while finding class " + name);
			return null;
		}
	}
	...
	private static Method maybeGetMethod(Class<?> clazz, String name,
		...
		try {
			...
			Log.e(TAG, "Unexpected error while finding method " + name);
			return null;
		}
	}
	...
	private static Object invoke(Method method, Object instance, Object... args) {
		try {
			...
			Log.e(TAG, "Unexpected error while invoking " + method);
			return null;
